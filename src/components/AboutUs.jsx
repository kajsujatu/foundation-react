...
const AboutUs = () => {
  ...
  return (
    <div className={styles.container_about_us}>
      ...
      <section id='prezes' className={styles.section}>
      ...
      <section id='wiceprezeska' className={styles.section}>
      ...
      <section id='patron' className={styles.section}>
        <h2 className={styles.title}>Patron Stanisław Strzyżyński</h2>
        <div className={styles.section_patron}>
          <div>
          <p>
            Urodzony 3 kwietnia 1923 r.
            w Kaliskach, woj. wielkopolskie. Zmarł 16 marca 2015 r. w
            Nałęczowie. Ukończył studia w Państwowej Wyższej Szkole Sztuk
            Plastycznych w Poznaniu w 1950 r. na Wydziale Rzeźby w pracowni
            prof. Bazylego Wójtowicza. Dyplom uzyskał w Akademii Sztuk Pięknych
            w Warszawie w 1955 r. u prof. Mariana Wnuka. W latach 1953-1983
            pracował w Państwowym Liceum Sztuk Plastycznych w Nałęczowie. Od
            1953 r. należał do Związku Polskich Artystów Plastyków pełniąc w nim
            przez wiele lat funkcję przewodniczącego sekcji rzeźbiarskiej.</p><p>
            Zorganizował 22 wystawy indywidualne m.in. w: Nałęczowie, Lublinie,
            Puławach, Kazimierzu Dolnym, Dęblinie, Słupsku, Sieradzu,
            Bełchatowie. Brał udział w ok. 100 wystawach zbiorowych m.in. w:
            Radomiu, Wrocławiu Sopocie, Bytomiu, Warszawie, Bielsko-Białej,
            Lublinie, Krakowie, Poznaniu, Gdańsku, Zamościu, Dęblinie, Berlinie,
            Moskwie, Sofii, Ravennie, Arezzo, Paryżu. </p><p>Jest autorem ponad
            dwudziestu pomników, kilkunastu rzeźb plenerowych i rzeźb
            sakralnych. Zrealizował m.in.: Pomnik ku czci Ofiar Faszyzmu w
            Bełżcu (1964), Pomnik Partyzantów w Łaszczowie (1966), Pomnik
            Bohaterskim Lotnikom w Dęblinie (1966), Pomnik Upamiętnienia Walk
            Kampanii Wrześniowej w Kocku (1968), Pomnik Partyzantów w Rąblowie
            (1969) i Samoklęskach (1969), Pomnik Pamięci Rozstrzelanych Rodzin w
            Zbędowicach (1981), Pomnik ku czci pomordowanych przez UB w Puławach
            (1995), Pomnik w hołdzie 17 żołnierzy AK poległych w walce z NKWD w
            1945 r. w Nałęczowie (1996), rzeźby plenerowe w Lublinie (1964),
            Nałęczowie (1977), Zamościu (1978), Świdniku (1979), Kraśniku
            (1979), pomniki Tadeusza Kościuszki w Maciejowicach (1982) i Kocku
            (1983), Maksymiliana Kolbe w Nałęczowie (1996), Chrystusa Zbawiciela
            w Warszawie (1996), ławeczki Bolesława Prusa w Nałęczowie (2002),
            Józefa Kraszewskiego w Romanowie (2007), Marii Cunitz w Świdnicy
            (2009), Stefana Żeromskiego w Siedlce (2010). </p><p>Jest laureatem wielu
            nagród i wyróżnień w ogólnopolskich i międzynarodowych konkursach
            rzeźbiarskich. Uzyskał m.in.: III nagrodę w konkursie na monety
            polskie - Warszawa 1958, wyróżnienie na wystawie lubelskiej
            XXX-lecia w twórczości plastycznej - 1964, I nagrodę w konkursie na
            pomnik Bohaterskim Lotnikom w Dęblinie 1966, wyróżnienie na
            Ogólnopolskiej Wystawie <i>Przeciw wojnie</i> - Lublin 1966, nagrodę
            na wystawie XXX-lecia ZPAP - Lublin 1966, główną nagrodę i
            wyróżnienie w Ogólnopolskim Konkursie na Pomnik Ofiar Majdanka -
            Warszawa 1967, wyróżnienie w konkursie na pomnik upamiętniający
            przełamanie Wału Pomorskiego - Koszalin 1968, nagrodę na
            Ogólnopolskiej Wystawie Plastyki |<i>Przeciw wojnie</i> - Lublin
            1969, wyróżnienie w międzynarodowym konkursie na pomnik Chana
            Asparuchowa - Sofia 1969, III nagroda na Międzynarodowej Wystawie{' '}
            <i>Przeciw wojnie</i> - Lublin 1979. </p><p>Prace artysty znajdują się
            m.in. w zbiorach: Centrum Rzeźby Polskiej w Orońsku, Muzeum
            Narodowym w Lublinie, Muzeum na Majdanku w Lublinie, Muzeum
            Medalierstwa we Wrocławiu, Muzeum Narodowym w Poznaniu, Muzeum
            Nadwiślańskim w Kazimierzu Dolnym, Muzeum Bolesława Prusa w
            Nałęczowie. </p><p>Został uhonorowany m.in.: Złotym Krzyżem Zasługi (1973),
            Medalem Komisji Edukacji Narodowej (1978), Odznaką
            <i>Zasłużony dla Lubelszczyzny</i> (1980), Odznaką{' '}
            <i>Zasłużony działacz kultury</i> (1980), Krzyżem Kawalerskim Orderu
            Odrodzenia Polski (1983), Krzyżem Oficerskim Orderu Odrodzenia
            Polski (2002).
          </p>
          </div>
      ...
      <section id='dzialania' className={styles.section}>
      ...
      <section id='czlonkowie-zarzadu' className={styles.section}>
      ...
      <section id='wspolpracownicy' className={styles.section}>
